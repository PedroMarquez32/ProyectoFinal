                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="px-6 py-3 text-left text-xs font-medium text-[#3a3a3c] uppercase">Título</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-[#3a3a3c] uppercase">Destino</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-[#3a3a3c] uppercase">Precio</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-[#3a3a3c] uppercase">Valoración</th>
            ...
            {showEditModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center overflow-y-auto p-4">
                <div className="bg-white p-8 rounded-lg w-full max-w-4xl my-8 relative">
                  ...
                  <div className="mt-4 flex justify-center space-x-4 sticky bottom-0 bg-white pt-4 border-t">
                    <button
                      onClick={async () => {
                        if (window.confirm('Are you sure you want to delete this destination?')) {
                          try {
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#4DA8DA] text-white rounded-md hover:bg-[#3a8bb9] transition-all duration-200"
                    >
                      Guardar Cambios
                    </button>
                  </div>
